...
| **F1** | **0** | 6 | 1 | **em execução** — as duas vermelhas fecharam em 26/07: F-02 na §9, F-03 por decisão normativa. `Q-SPEC001-08`, `MT-09` e `Q-CLAUDE11-01` abertas em 27/07; `MT-06` e `Q-RBAC-01` resolvidas no mesmo dia (§9) |
| F2 | 2 | 3 | 2 | — |
| F3 | 2 | 1 | 0 | — |
| F6 | 0 | 1 | 1 | — |
