...
tests/                       1258 verificacoes em 48 suites. `npm test` roda todas.
...
```bash
npm test          # typecheck + as 48 suites, 1258 verificacoes (linhas `ok`)
