...
tests/                       964 verificacoes em 37 suites. `npm test` roda todas.
                             ...
                             npm test: 854 -> 964, diferenca ZERO. E a terceira
...
```bash
npm test          # typecheck + as 37 suites, 964 verificacoes (linhas `ok`)
