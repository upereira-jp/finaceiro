...
tests/                       1241 verificacoes em 47 suites. `npm test` roda todas.
...
```bash
npm test          # typecheck + as 47 suites, 1241 verificacoes (linhas `ok`)
